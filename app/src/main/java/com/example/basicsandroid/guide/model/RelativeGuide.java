package com.example.basicsandroid.guide.model;
...
public class RelativeGuide {
    ...
    public int padding;
    public int gravity;
    public boolean mIsAddSub = true;//表示此时设置的宽度是加还是减   默认是true
     ...
     */
    public RelativeGuide(@LayoutRes int layout, @LimitGravity int gravity, int padding, boolean isAddSub) {
        this.layout = layout;
        this.gravity = gravity;
        this.padding = padding;
        this.mIsAddSub = isAddSub;
    }
